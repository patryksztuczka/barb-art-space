...
const FeaturedWorkCard = ({ work }: IFeaturedWorkCardProps) => {
  ...
  return (
    <div className="relative flex aspect-square h-[550px] max-h-[353px] w-full items-end justify-between gap-4 bg-gradient-to-t from-black/75 to-transparent px-4 py-3 xl:aspect-auto xl:flex-col xl:items-start xl:justify-end xl:gap-2">
